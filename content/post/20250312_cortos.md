...
No sé qué pensar de gente que descubre un algoritmo de arbitraje en un mercado y, en lugar de explotarlo y enriquecerse, escribe [una entrada de blog](https://nadaesgratis.es/admin/blockchain-i-las-limitaciones-del-algoritmo-cpmm).

[La política de competencia tiene habitualmente una agenda oculta](https://www.economist.com/business/2025/03/06/the-worlds-trustbusters-hint-that-they-want-more-deals). Defiende la competencia, revisa la concentración empresarial, sí, pero también se encuentra subrepticiamente al servicio de otras políticas ajenas al mandato anterior.
...
Los que sabemos quién es `rms` ---entre otras cosas, pero esa es condición suficiente--- nos reímos un poco. Con cierta amargura, pero nos reímos. (Estoy seguro de que la autora también sabe quién es, pero ha preferido armar un refrito de argumentos idóneos para publicar en El País, que es algo que viste mucho).
...
Mientras tanto, en occidente se reduce el número de menciones a palabras tales como _fat_, _flabby_, _ugly_ y _Kipling_ porque, según
[esto](https://www.economist.com/britain/2023/03/23/editing-roald-dahl-for-sensitivity-was-silly), a los editores de Roald Dahl les ha dado por purgar esos términos tan poco generosos de las nuevas ediciones de sus obras.

...
sobre lo que su largo título indica porque mezcla de manera oscura _rivalidad_ y _posibilidad de excluir_ en la definición de bien público. De hecho, los datos, en principio, admiten la posibilidad de uso exclusivo. Se parecen más a una piscina, que no tiene _rivalidad_ de uso, pero sí posibilidad de excluir a quienes no abonen una tarifa.
...
- Los derechos de propiedad de los datos ---o de los datos a los que se refiere la entrada--- están distribuidos entre tantos agentes (los N ciudadanos) que gestionar sus derechos es muy costoso.
- El precio que estaría dispuesto a pagar cada agente que pretenda usar los datos a cada uno de los ciudadanos es minúsculo: no sale a cuenta venderlos.

...
- política
date: 2025-11-06
description: Reflexión sobre la contradicción aparente, la moderación y el pensamiento
  crítico a partir de una conferencia de Víctor Lapuente y un texto de Joseph Heath.
lastmod: '2025-11-13T20:21:57.263498'
related:
...
- populismo
- joseph heath
title: Sobre las disonancias cognitivas del centrismo
url: /2025/centrismo-disonancia-cognitiva/
---

[Mencioné](/2025/desintermediacion-cooperacion/) en una entrada previa una conferencia de Víctor Lapuente a la que asistí recientemente. Resumí el argumento principal pero dejé en el tintero un asunto al que vuelvo ahora y que motiva una reflexión específica.
...
Por otro lado, Joseph Heath publicó recientemente [_Populism fast and slow_](https://josephheath.substack.com/p/populism-fast-and-slow), tal vez la mejor y más coherente descripción que haya leído de lo que es el populismo. Lo relaciona precisamente con la capacidad de activar el _sistema 2_ ---el popularizado por Kahneman--- para resolver esas cuestiones que al _sistema 1_ se le antojan contradictorias y difíciles de conciliar con el sentido común.
